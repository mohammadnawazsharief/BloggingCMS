            ...
            <div class="col-lg-8">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{$first_posts->featured}}" alt="{{$first_post->title}}">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            {{$first_posts->created_at->diffForHumans()}}
                                            </time>
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{$second_posts->featured}}" alt="{{$second_posts->title}}">
                            <div class="overlay"></div>
                            <a href="{{$second_posts->featured}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center ">
                                        <a href="15_blog_details.html">{{$second_posts->title}}</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                                {{$second_posts->created_at->toFormattedDateString()}}
                                            </time>
            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            <img src="{{$third_posts->featured}}" alt="seo">
                            <div class="overlay"></div>
                            <a href="{{$third_posts->featured}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center ">
                                        <a href="15_blog_details.html">{{$third_posts->title}}</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                                {{$third_posts->created_at->toFormattedDateString()}}
                                            </time>
